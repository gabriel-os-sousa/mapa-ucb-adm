      ...
      <div id="content">
        ...
        <div class="container-fluid">
          ...
          <div class="text-center">
            <p class="lead text-red-800 mb-5">Erro :(</p>
            <p class="text-red-500 mb-0">Ocorreu um erro inesperado, favor contacte o administrador do sistema.</p>
            <a onclick="window.history.go(-1); return false;" href="#">&larr; Voltar</a>
          </div>
