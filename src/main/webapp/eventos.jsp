          ...
          %>
           ...
           <div class="card shadow mb-4">
                ...
                <div class="card-body" style="padding: 0.75rem;">
                  <p><span><b>Tipo:</b> <%= evento.getTipo() %></span><span> - <b>Local:</b> <%=evento.getNomeLocal()%></span><span> - <b>Data de cadastro: </b><%= Strings.dateHourToString(evento.getDataCadastro()) %></span></p>
                  <p><span><b>Início:</b> <%= Strings.dateToString(evento.getData_inicio()) %></span><span> - <b>Fim:</b> <%= Strings.dateToString(evento.getData_fim()) %></span><span> - <b>Horário: </b><%= evento.getHorario() %></span></p>
